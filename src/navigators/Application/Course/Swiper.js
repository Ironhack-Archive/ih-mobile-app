...
export default class extends Component {
  ...
  renderPagination = () => {
    ...
    return (
      ...
      //   <Text style={{ textAlign: 'center', alignItems: 'center', fontFamily: 'Roboto Slab', color: this.props.dotColor || 'rgba(0,0,0,.2)', justifyContent: 'center' }}>
      //     {this.props.title}
      //   </Text>
        <View pointerEvents='box-none' style={[styles['pagination_' + this.state.dir], this.props.paginationStyle]}>
          <TouchableOpacity onPress={this.props.onClosePress} style={{ flex: 1, paddingLeft: 32 }}>
            <Ionicons name='md-close' size={35} color={this.props.activeDotColor}/>
          </TouchableOpacity>
          {/* <View> */}
            {/* <Text style={{ textAlign: 'center', alignItems: 'center', fontFamily: 'Roboto Slab', color: this.props.dotColor || 'rgba(0,0,0,.2)', justifyContent: 'center' }}>{this.props.title}</Text> */}
  ...
  renderTitle = () => {
    ...
    return title
      ? (<View style={styles.title}>
        <Text style={{ textAlign: 'center', alignItems: 'center', fontFamily: 'Roboto Slab', color: this.props.dotColor || 'rgba(0,0,0,.2)', justifyContent: 'center' }}>{title}</Text>
      </View>)
      : null
  }
